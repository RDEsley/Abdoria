...
export const additionalExercises = [
  ...
  ),
  {
    ...
    tempo_recomendado: 30,
    prioridade: 'A',
    descricao: 'Foco: peito. Flexão clássica com mãos na largura dos ombros.',
  ...
  },
  {
    slug: 'knee-push-up',
    nome: 'Knee Push-Up',
    nome_pt: 'Flexão com joelhos no chão',
    nivel: 1,
    musculo_principal: 'superior',
    musculos_secundarios: ['core'],
    tempo_recomendado: 30,
    prioridade: 'A',
    descricao: 'Foco: peito. Versão mais leve com os joelhos apoiados no chão.',
  ...
  },
  {
    ...
    tempo_recomendado: 30,
    prioridade: 'A',
    descricao: 'Foco: peito. Mãos elevadas em um apoio firme para reduzir a carga.',
  ...
  },
  {
    ...
    tempo_recomendado: 30,
    prioridade: 'B',
    descricao: 'Foco: peito. Pés elevados para aumentar a carga na parte superior do peito.',
  ...
  withCustomParams(
    {
      ...
      prioridade: 'A',
      modo: 'reps',
      descricao: 'Foco: peito. Mãos mais abertas que os ombros e descida controlada.',
      media: { gif: 'push-up.gif' },
      ativo: true,
    },
    { repeticoes_iniciante: 6, repeticoes_intermediario: 10, repeticoes_avancado: 15 },
  ),
  withCustomParams(
    {
      slug: 'close-grip-push-up',
      nome: 'Close-Grip Push-Up',
      nome_pt: 'Flexão fechada',
      nivel: 2,
      musculo_principal: 'superior',
      musculos_secundarios: ['core'],
      tempo_recomendado: 30,
      prioridade: 'A',
      modo: 'reps',
      descricao: 'Foco: tríceps. Mãos próximas e cotovelos junto ao corpo.',
      media: { gif: 'push-up.gif' },
      ativo: true,
    },
    { repeticoes_iniciante: 5, repeticoes_intermediario: 9, repeticoes_avancado: 13 },
  ),
  withCustomParams(
    {
      ...
      prioridade: 'A',
      modo: 'reps',
      descricao: 'Foco: tríceps. Mãos juntas sob o peito formando um diamante.',
      media: { gif: 'push-up.gif' },
      ativo: true,
    },
  ...
  withCustomParams(
    {
      ...
      prioridade: 'B',
      modo: 'reps',
      descricao: 'Foco: ombros. Incline o corpo à frente e mantenha os cotovelos controlados.',
  ...
  withCustomParams(
    {
      slug: 'wide-scapular-push-up',
      nome: 'Wide Scapular Push-Up',
      nome_pt: 'Flexão escapular aberta',
      nivel: 3,
      musculo_principal: 'superior',
      ...
      prioridade: 'B',
      modo: 'reps',
      descricao: 'Foco: costas. Mãos abertas e movimento curto apenas das escápulas.',
      media: { gif: 'push-up.gif' },
      ativo: true,
    },
    { repeticoes_iniciante: 8, repeticoes_intermediario: 12, repeticoes_avancado: 15 },
...
>(exercise: T): T & { grupos: ParteCorpo[]; contraindicacoes: RestricaoFisica[] } {
  return {
    ...
    contraindicacoes: exercise.contraindicacoes ?? EXERCISE_CONTRAINDICACOES[exercise.slug] ?? [],
  };
}
