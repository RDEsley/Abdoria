...
const WORKOUT_STARTED_AT_KEY = 'abdoria_workout_started_at';
const WORKOUT_ENDED_AT_KEY = 'abdoria_workout_ended_at';
const WORKOUT_PAUSED_MS_KEY = 'abdoria_workout_paused_ms';
