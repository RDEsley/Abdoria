...
export function mergeAfkCombatSnapshot(
  ...
  return {
    ...
    search_remaining_ms: server.search_remaining_ms,
    hero_attack_remaining_ms: server.hero_attack_remaining_ms,
    enemy_attack_remaining_ms: server.enemy_attack_remaining_ms,
