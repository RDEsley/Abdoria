  ...
  return (
    <section ref={sectionRef} className="glass-card p-4">
      <div className="flex items-center justify-between gap-3">
        <h3 className="game-section-title !mb-0 leading-none">Atividades</h3>
      ...
      <div className="atividades-flip-viewport">
        <div className="atividades-flip-panel">
          {atividades.length > 0 && (
          ...
          <p className="flex items-center gap-1.5 text-xs font-semibold text-stone-500">
            {diaDeTreino ? (
              ...
              <>
                <CalendarClock size={12} aria-hidden /> Não agendadas hoje — ajuste no calendário
                acima
              </>
            )}
          </p>
