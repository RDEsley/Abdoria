    ...
    >
      ...
      >
        ...
        <p className="game-modal__text">
          Escolha uma sugestão ou monte repetições e séries do seu jeito.
        </p>

        <p className="mt-4 text-xs font-extrabold uppercase tracking-wide text-stone-500">
          Sugestões para {nivel}
        </p>
