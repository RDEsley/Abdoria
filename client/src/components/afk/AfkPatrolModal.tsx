  ...
  return createPortal(
    <div className="game-afk-overlay" role="dialog" aria-modal="true" aria-labelledby="afk-patrol-title" onClick={onClose}>
      ...
      >
        ...
        <p className="game-modal__text">Seu herói defende Abdoria enquanto você está fora.</p>

        <div className="game-afk-scene">
          <div className="game-afk-scene__lens game-afk-scene__lens--left" aria-hidden />
          <div className="game-afk-scene__lens game-afk-scene__lens--right" aria-hidden />
          <div className="game-afk-scene__viewport">
            ...
            <div className={`game-afk-hero game-afk-hero--${weapon}${attacking ? ' game-afk-hero--attack' : ''}`} aria-hidden>
              ...
              {weapon === 'arco' ? <div className="game-afk-hero__bow" /> : <Sword className="game-afk-hero__sword" size={20} />}
            </div>
            ...
            {attacking && weapon === 'arco' && <div className="game-afk-arrow" aria-hidden />}
          </div>
        </div>
        ...
        <div className="game-afk-timer" aria-live="polite">
          ...
          <span className="game-afk-timer__value tabular-nums">
            {loading ? '--:--:--' : formatAfkTimer(meta?.minutos_acumulados ?? 0)}
          </span>
        </div>
