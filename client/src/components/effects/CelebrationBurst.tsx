...
/** Flash + efeito cosmético equipado, usado em reveals de recompensa (códigos presente etc). */
export function CelebrationBurst({ effectId, message, onComplete, fullscreen = false }: Props) {
  useEffect(() => {
